...
(function() {
	...
	var feedback = {
		...
		lxr: document.getElementById('lxr'),
		mobile: document.getElementById('mobile'),
		imageList: document.getElementById('image-list'),
		submitBtn: document.getElementById('submit')
	};
	var url =  my.getUrl() + 'wybx/wybxapply';
	//	var url = 'http://120.77.179.240:8888/upload.php';
...
//		feedback.files = feedback.files.substring(0,feedback.files.length-1);
//		alert(feedback.files);
		feedback.send(mui.extend({}, feedback.deviceInfo, {
			content: feedback.question.value,
			contact: feedback.contact.value,
			lxr: feedback.lxr.value,
